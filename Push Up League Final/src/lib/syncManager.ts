    ...
    try {
      ...
      if (profile) {
        ...
        useEnhancedStore.setState({
          ...
          dailyGoalLastAdjustedDate: profile.dailyGoalLastAdjustedDate || null,
          recommendedDailyGoal: profile.recommendedDailyGoal || profile.dailyGoal,
          customDailyGoal: profile.customDailyGoal || null,
          goalAdjustmentMode: (profile.goalAdjustmentMode as any) || 'balanced',
          lastGoalAdjustment: profile.lastGoalAdjustment || null,
          recoveryModeUntil: profile.recoveryModeUntil || null,
          recoveryReductionPercent: profile.recoveryReductionPercent || 25,
        ...
        await createUserProfile(user.uid, {
          ...
          dailyGoalLastAdjustedDate: store.dailyGoalLastAdjustedDate,
          recommendedDailyGoal: store.recommendedDailyGoal,
          customDailyGoal: store.customDailyGoal,
          goalAdjustmentMode: store.goalAdjustmentMode,
          lastGoalAdjustment: store.lastGoalAdjustment,
          recoveryModeUntil: store.recoveryModeUntil,
          recoveryReductionPercent: store.recoveryReductionPercent,
      ...
      if (workouts.length > 0) {
        useEnhancedStore.setState({
          workouts: workouts.map(w => ({
            ...
            dailyGoalAtTime: w.dailyGoalAtTime || useEnhancedStore.getState().dailyGoal,
            quality: w.quality,
        ...
        useEnhancedStore.setState({ workouts: [] });
      }
    ...
    try {
      ...
      if (saved) {
        ...
        useEnhancedStore.setState({
          ...
          dailyGoalLastAdjustedDate: data.dailyGoalLastAdjustedDate || null,
          recommendedDailyGoal: data.recommendedDailyGoal || data.dailyGoal || 50,
          customDailyGoal: data.customDailyGoal || null,
          goalAdjustmentMode: data.goalAdjustmentMode || 'balanced',
          lastGoalAdjustment: data.lastGoalAdjustment || null,
          recoveryModeUntil: data.recoveryModeUntil || null,
          recoveryReductionPercent: data.recoveryReductionPercent || 25,
