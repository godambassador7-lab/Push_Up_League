...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { id: 'special_speed_demon_10', title: 'Speed Demon 10', description: 'Complete 10 push-ups in under 10 seconds', type: 'special', requirement: '<10s', icon: '⏱️', xpReward: 50, coinReward: 10, checkUnlock: () => false },
  { id: 'special_speed_demon_25', title: 'Speed Demon 25', description: 'Complete 25 push-ups in under 25 seconds', type: 'special', requirement: '<25s', icon: '⏲️', xpReward: 100, coinReward: 20, checkUnlock: () => false },
  { id: 'special_speed_demon_50', title: 'Speed Demon 50', description: 'Complete 50 push-ups in under 50 seconds', type: 'special', requirement: '<50s', icon: '⏰', xpReward: 200, coinReward: 40, checkUnlock: () => false },
  { id: 'special_speed_demon_100', title: 'Speed Demon 100', description: 'Complete 100 push-ups in under 2 minutes', type: 'special', requirement: '<2min', icon: '⌚', xpReward: 400, coinReward: 80, checkUnlock: () => false },
  ...
  { id: 'special_consistency_god', title: 'Consistency God', description: 'Never miss more than 1 day in a row for 365 days', type: 'special', requirement: '365 days', icon: '⚖️', xpReward: 2000, coinReward: 400, checkUnlock: () => false },
  ...
  { id: 'special_variety_god', title: 'Variety God', description: 'Complete 1000 reps of each push-up type', type: 'special', requirement: 'All 1000', icon: '🌈', xpReward: 2000, coinReward: 400, checkUnlock: (data) => Object.values(data.variationStats).every(v => v >= 1000) },
